...
function comprobar(){
  ...
  entrada.value="";
    ...
    if (cero==0) resultado.textContent="¡¡ENHORABUENA!! No has ganado nada";
    else resultado.textContent="Has perdido ¿¡Como....!?";
  }
}
var numAl=Math.round(Math.random() * (4 - 0));
console.log(numAl);

var palabras=["zarza", "almanaque", "chaqueta", "perro", "esternocleidomastoideo"]
